...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> pages = [const Highligths(), const FoodMenu(), const DrinkMenu()];
    return Scaffold(
      appBar: AppBar(
        title: const Text("Riimamura Restaurant", style: TextStyle(fontFamily: 'Caveat', fontSize: 26),),
